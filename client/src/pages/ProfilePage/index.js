        ...
        <div>
          ...
          <Container>
            ...
            <Row>
              <Col>
                <form>
                  ...
                  <div className="form-group">
                    <label for="exampleFormControlInput1" className="input">
                      Email address
                    </label>
                    <input
                      type="email"
                  ...
                  <div className="form-group">
                    <label for="Phone" className="input">
                      Phone Number
                    </label>
                    <input
                      type="phone"
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="inputCity" className="input">
                        City
                      </label>
                      <input
                        type="text"
                    ...
                    <div class="form-group col-md-4">
                      <label for="inputState" className="input">
                        State
                      </label>
                    ...
                    <div class="form-group col-md-2">
                      <label for="inputZip" className="input">
                        Zip
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="form-group">
                    <label for="exampleFormControlSelect1" className="input">
                      Amount Of Time That You Can Commit
                    </label>
                    <select
                  ...
                  <Row>
                    <Col>
                      <div>
                        <label id="interests" className="input">
                          Interests
                        </label>
                      </div>
                    </Col>
                  ...
                  <Row>
                    <Col>
                      <div className="checkbox">
                        <label>
                          <input type="checkbox" value="" /> Cooking & Baking
                        </label>
                      </div>
                      <div className="checkbox">
                        <label>
                          <input type="checkbox" value="" /> Community Cleanups
                        </label>
                      </div>
                      <div className="checkbox">
                        <label>
                          <input type="checkbox" value="" /> Teaching & Training
                        </label>
                      </div>
                    </Col>
                    <Col>
                    ...
                    <Col>
                      ...
                      <div className="checkbox">
                        <label>
                          <input type="checkbox" value="" /> Harvest & Farming
                        </label>
                      </div>
                      <div className="checkbox">
                        <label>
                          <input type="checkbox" value="" /> Home Improvement &
                          DIY
                        </label>
                      </div>
                    </Col>
                  ...
                  <Row>
                    <Col>
                      <div>
                        <label id="skills" className="input">
                  ...
                  <Row>
                    <Col>
                      ...
                      <div className="checkbox">
                        <label>
                          <input type="checkbox" value="" /> Event Planning
                        </label>
                      </div>
                      <div className="checkbox">
                        <label>
                    ...
                    <Col>
                      <div className="checkbox">
                        <label>
                          <input type="checkbox" value="" /> Heavy Lifting
                        </label>
                      </div>
                      <div className="checkbox">
                        <label>
                    ...
                    <Col>
                      ...
                      <div className="checkbox">
                        <label>
                          <input type="checkbox" value="" /> Writing & Editing
                        </label>
                      </div>
                      <div className="checkbox">
                        <label>
                          <input type="checkbox" value="" /> Guest Speaking
                        </label>
                      </div>
                    </Col>
                    <Col />
            ...
            <Row>
              <Col />
              <Col>
                <img id="submit" src="./images/submit.png" alt="" />
              </Col>
            </Row>
            <br /> <br /> <br /> <br />
          </Container>
